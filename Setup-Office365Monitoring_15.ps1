...
$DefaultOffice365Domain = "something.onmicrosoft.com"
$DefaulLMTenantName = "whatever"
$DefaultLMApiId = ''
$DefaultLMApiKey = ''
$DefaultLMDeviceName = "displayname as shown in logicmonitor"
...
Function Upload-DataSource ($Tenant, $AccessID, $AccessKey, $DataSourceXML)
{
    ...
    Write-Log -Message "Uploading DataSource."
    Write-Log -Message "API call: $Url"
...
Function Show-MainForm
{
    ...
    $Label9.Text = "This will create an app in your `n Office365 account and get info from it."
    $Label9.Location = "500,90"
    $Label9.Size = "200,25"
    $Label9.TextAlign = "MiddleCenter"

    $Label10.Text = "This will apply/attach the DataSource`nto the device you select and set`nrequired properties on the device."
    $Label10.Location = "500,185"
    $Label10.Size = "200,40"
    $Label10.TextAlign = "MiddleCenter"

    $Label11.Text = "Status: Ready"
    $Label11.Location = "500,335"
    $Label11.Size = "200,25"
    ...
    $Label13.Size = "200,40"
    $Label13.TextAlign = "MiddleCenter"
    ...
    $TextBox8.add_Leave({
        ...
        if ($TextBox8.Text.Length -eq 0)
        {
            ...
            $TextBox8.Text = "The display nameas it shows in the device tree"
        }
    })
    $TextBox8.add_Enter({
    ...
    $Button2.add_Click({
        ...
        Write-Log -Message "Disconnecting AzureAD"
        Disconnect-AzureAD
    ...
    $Button3.add_Click({
        ...
        Write-Host $ResultGraph.refresh_token
        ...
        {
            Write-Log -Message "Deploying Office 365 datasource template."
        ...
        {
            Write-Log -Message "Deploying Graph API datasource template."
    ...
    $CheckBox1.Text = "Import Office 365 DataSource"
    $CheckBox1.Location = "500,245"
    $CheckBox1.Size = "210,25"

    $CheckBox2.Text = "Import Exchange email stats DataSources"
