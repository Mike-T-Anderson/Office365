...
$DataSourceO365File = "$(Get-Location)" + "\Datasource_Office365.xml"
$DataSourceGraphFile1 = "$(Get-Location)" + "\Datasource_Graph1.xml"
$DataSourceGraphFile2 = "$(Get-Location)" + "\Datasource_Graph2.xml"
$DataSourceGraphFile3 = "$(Get-Location)" + "\Datasource_Graph3.xml"
